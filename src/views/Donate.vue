	...
	<div class="window white">
	        <fieldset class='poolsdialog donations'>
	            ...
	            <div :class="{selected: activeLink == 1}">
	                <a href='https://explorer.waterfall.network/address/0x28b88cfD875C883cDb61938C97B8d1baabf31c88'>1.<img class='icon ethicon' :src="publicPath + 'ethereum-brands_optimized.svg?rev=8160e2e87988f42e44fd33495dead52c'" /><span class='text'>0x28b88cfD875C883cDb61938C97B8d1baabf31c88</span></a>
	            </div>
...
<script>
	export default {
		metaInfo: {
	      title: 'Curve Waterfall Interface :: Donate',
	      meta: [
